...
***IPORTANT*** In the above videos easycrypt is just installed as a regular context menu script in nautilus, there is also a real nautilus extension which is now used instead, you can install it however you want though, as a script or an extension to nautilus.
